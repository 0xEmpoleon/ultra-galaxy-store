...
const DESIGN_SYSTEMS = {
    ...
    steakhouse: {
        '--sys-bg-main': '#002B24',
        '--sys-text-primary': '#ffffff',
        '--sys-text-secondary': 'rgba(255, 255, 255, 0.6)',
        '--sys-border': 'rgba(255, 255, 255, 0.1)',
        '--bi-divider': 'rgba(255, 255, 255, 0.1)',
        '--bi-bg': '#001a16',
        '--bi-text': '#ffffff',
        ...
        '--sys-font-primary': "'Inter', sans-serif",
        '--sys-font-display': "'Inter', sans-serif",
        '--sys-accent-shadow': '0 0 40px rgba(16, 127, 98, 0.3)',
        '--sys-button-radius': '8px',
        '--sys-button-bg-hover': '#107F62',
        '--sys-button-text-hover': '#ffffff',
        '--sys-3d-color': '#107F62',
        '--sys-3d-edge': '#002B24',
        '--strategy-prime': '#2D5450',
    ...
    colab: {
        ...
        '--bi-text': '#180F26',
        '--bi-header-bg': '#E8E5DC',
        '--sys-font-primary': "'Ppneuemontreal', Arial, sans-serif",
        '--sys-font-display': "'Roslindale Condensed', 'Times New Roman', serif",
